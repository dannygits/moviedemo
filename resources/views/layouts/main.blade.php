        ...
        <div class="container mx-auto px-12 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-4 md:mt-0">
                    <a href="#" class="text-gray-700 hover:text-gray-400">movies</a>
                </li>
                <li class="md:ml-6 mt-4 md:mt-0">
                    <a href="#" class="text-gray-700 hover:text-gray-400">TV shows</a>
                </li>
                <li class="md:ml-6 mt-4 md:mt-0">
                    <a href="#" class="text-gray-700 hover:text-gray-400">actors</a>
                </li>
            </ul>

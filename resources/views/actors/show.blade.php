...
@section('content')
    <div class="movie-info border-b border-gray-400">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl text-gray-800 mt-4 md:mt-0 font-semibold">{{ $actor['name'] }}</h2>
                ...
                <h4 class="font-semibold text-gray-700 mt-12">Known For</h4>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            ...
                            <a href="{{ route('movies.show', $movie['id']) }}" class="text-sm leading-normal block text-gray-600 hover:text-white mt-1">{{ $movie['title'] }}</a>
                        </div>
    ...
    <div class="credits">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl text-gray-800 font-semibold">Credits</h2>
            <ul class="list-disc text-gray-600 leading-loose pl-5 mt-8">

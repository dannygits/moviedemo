    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex">
            ...
            <div class="ml-24">
                ...
                <div class="mt-2">
                    <div class="flex items-center text-gray-700 text-md">
                    ...
                    <p class="text-gray-700 mt-8">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, voluptas, veniam sed sunt consequatur ad, minus consequuntur dolor eum numquam quod tempore vero perspiciatis nihil. Unde dolor, reiciendis iste ex debitis, eos vitae, nostrum ratione nobis eaque quibusdam. Nostrum fuga ullam ratione deleniti praesentium provident vitae, eum iusto officia mollitia?
                    </p>
                    ...
                    <div class="mt-12">
                        ...
                        <div class="flex mt-4">
                            <div>
                                <div class="text-gray-700">Bong Joon-ho</div>
                                <div class="text-sm text-gray-700">Screenplay, Director, Story</div>
                            </div>
                            <div class="ml-8">
                                <div class="text-gray-700">Han Jin-won</div>
                                <div class="text-sm text-gray-700">Screenplay</div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-12">
        ...
        <div class="movie-cast border-b border-gray-400">
            <div class="container mx-auto px-4 py-16">
                <h2 class="text-4xl text-gray-700 font-semibold">Cast</h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    <div class="mt-8">
                        ...
                        <div class="mt-2">
                            <a href="#" class="text-lg mt-2 text-gray-700 hover:text-gray:300">Real Name</a>
        ...
        <div class="movie-images">
            <div class="container mx-auto px-4 py-16">
                <h2 class="text-4xl text-gray-700 font-semibold">Images</h2>
